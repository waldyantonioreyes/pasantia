<?php
// centrosdetrabajos-lista.php

$pageTitle = "Listado de Centros de Trabajo";
...
/* === SOLUCIÓN SCROLL EN MODAL === */
#formEditar {
    max-height: 90vh;        /* Limita el alto máximo */
...
/* Evita que el fondo se mueva mientras la modal está abierta */
body.modal-open {
    overflow: hidden;
}
...
<script>
    function confirmarEliminar() {
        return confirm('¿Estás seguro de que deseas eliminar este centro de trabajo?');
    }

    function abrirEdicion(id, nombre, direccion, rnc, area, responsable, correo, telefono, whatsApp, estado) {
        document.getElementById('modalOverlay').style.display = 'block';
        document.getElementById('formEditar').style.display = 'block';
        document.getElementById('edit_id').value = id;
        document.getElementById('edit_nombre').value = nombre;
        document.getElementById('edit_direccion').value = direccion;
        document.getElementById('edit_rnc').value = rnc;
...
<div class="container">
    <div class="header">
        <h1>Lista de Centros de Trabajo</h1>
    </div>

    <div class="content">
        <?php
        // Cargar los centros desde el controlador
        $centros = include '../../controllers/centrosdetrabajos.php';

        // Mostrar mensajes
        if (isset($_GET['msg'])): ?>
            <?php if ($_GET['msg'] == 'deleted'): ?>
                <div class="msg success">Centro eliminado correctamente.</div>
            <?php elseif ($_GET['msg'] == 'updated'): ?>
                <div class="msg success">Centro actualizado correctamente.</div>
            <?php elseif ($_GET['msg'] == 'empty_fields'): ?>
                <div class="msg error">Debes completar todos los campos obligatorios.</div>
            <?php else: ?>
        ...
        <div class="table-wrapper">
            <a href="../../public/centrosdetrabajos/registro.php">Registrar nuevo centro</a>
            <table>
                <thead>
                    <tr>
                        <th>ID</th>
                                ...
                                <div style="display: flex; gap: 6px;">
                                    <button class="btn-edit"
                                        onclick="abrirEdicion(
                                            ...
                                            '<?= htmlspecialchars($c['rnc']); ?>',
                                            '<?= htmlspecialchars($c['area']); ?>',
                                    ...
                                    <form method="post" action='../../controllers/centrosdetrabajos.php' 
        ...
        <div id="formEditar">
            ...
            <h3>Editar Centro de Trabajo</h3>
            <form method="post" action="../../controllers/centrosdetrabajos.php">
                ...
                <label>RNC:</label>
                <input type="text" name="rnc" id="edit_rnc">
